...
<body>
        ...
        <table id="example" class="table table-striped" style="width:100%">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="hapus_foto.php?fotoid=<?= $data['fotoid'] ?>" class="btn btn-outline-danger">Remove</a>
                <hr>
            ...
            <!-- Modal edit-->
            <div class="modal fade" id="edit<?= $no ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
  ...
  <footer class="d-flex justify-content-center border-top mt-3 bg-light fixed-bottom">
    <p>&copy; Website Gallery Photo | Arsila Dwi Julita</p>
  </footer>
